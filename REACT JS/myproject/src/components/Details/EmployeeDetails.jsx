                      ...
                      <tr>
                        ...
                        <td className='data-row'>
                          {isEditContactNumber === false ? (
                            ...
                            <div className='data-row'>
                              <div><input type="number" onChange={(e) => setNewContactNumber(e.target.value)} className='form-control edit-employee' placeholder='Contact Number' /></div>
                              {editLoading === false ? (
                                <div className='data-row edit-buttons'>
                                ...
                                <div className="div5">
                                  <div className="loginCredentialDiv">
                                    ...
                                    <div className="passwordDiv">
                                      ...
                                      <input type="password" name="password"  value={newPassword} disabled className='form-control edit-employee' placeholder='Password' />
                                    </div>
                                  </div>
                                </div>
                              ) : null}
